...
export default function PremierePro(props: any) {
  ...
  const animateValue = () => {
    ...
    const animate = () => {
      ...
      const easedValue = easeInOut(progress, 0, 65);
      ...
      <div className='block shrink-0'>
        ...
        >
          <div className='flex text-lg items-center space-x-3 max-w-max'>
            <SiAdobepremierepro className='text-[36px]' />
            <div className='mt-1'>
              <p className='text-white text-xs mt-1'>Adobe Premiere Pro</p>
              <progress
