...
export default function AfterEffect(props: any) {
  ...
  const animateValue = () => {
    ...
    const animate = () => {
      ...
      const easedValue = easeInOut(progress, 0, 52);
      ...
      <div className='block shrink-0'>
        ...
        >
          <div className='flex text-lg items-center space-x-3 max-w-max'>
            <SiAdobeaftereffects className='text-[36px]' />
            <div className='mt-1'>
              <p className='text-white text-xs mt-1'>Adobe After Effect</p>
              <progress
